...
% Die folgenden Abschnitte beleuchten diese Herausforderungen anhand
...
\input{content/Herausforderungen/05_01_Sicherheits_und_Datenschutzaspekte.tex}

\subsection{Sicherheitsrisiken durch generative Modelle}
\input{content/Herausforderungen/05_01_01_Sicherheitsrisiken_durch_generative_Modelle.tex}

\section{Ethische und soziale Implikationen}
\input{content/Herausforderungen/05_02_Ethische_und_soziale_Implikationen.tex}

\subsection{Ethische Konflikte und Bias in KI-Systemen}
\input{content/Herausforderungen/05_02_01_Ethische_Konflikte_und_Bias_in_KI_Systemen.tex}

\subsection{Langfristige Auswirkungen auf Entwickler:innen-Rollen}
\input{content/Herausforderungen/05_02_02_Langfristige_Auswirkungen_auf_Entwicklerrollen.tex}

\subsection{Technische und organisatorische Hürden bei der Einführung von KI}
\input{content/Herausforderungen/05_02_03_Technische_und_organisatorische_Huerden_bei_der_Einfuehrung_von_KI.tex}
